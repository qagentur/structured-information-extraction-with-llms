...
- Slides and code are available on GitHub: <qagentur.github.com/structured-extraction-workshop>
...
- Have you used a structured output API?
...
<div style="background-color: #03FFAB; color: white; border-radius: 5px; color: black;">
...
- Lack of training data to train a classic model
- Great amount of built-in knowledge
- Extreme flexibility:
  - Multiple tasks with the same model
...
- Use the [AG News dataset](https://huggingface.co/datasets/fancyzhx/ag_news) at <https://huggingface.co/datasets/fancyzhx/ag_news> if you need examples
...
## Exercise 5: Evaluation & competition

Let's have a little **competition** and **see how high we can get the accuracy**. Everything is allowed, except for changing the model or using fine-tuning. Collaboration is encouraged.

At the end of our allotted time, I'll count down from an accuracy of 100%, asking if someone reached that accuracy.

Participation is optional — if you'd rather not compete and just try out things at your own pace, that's fine too 😊
...
TODO: Add benchmarks closer to the workshop date
...
![Production system overview](assets/production.svg)
...
- supported by most LLM client libraries
...
Essential for identifying issues, improving performance, managing costs, and for compliance.

- Minimalist approach: write log files and query them later
- More sophisticated: LLM-specific monitoring tools like [Langfuse](https://langfuse.com), [W&B Weave](https://wandb.ai/site/weave/), and [Langsmith](https://langsmith.com)

TODO: Check these recommendations
