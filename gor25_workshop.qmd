...
- Notebook is on [Google Colab](https://colab.research.google.com/drive/1lpQDRxTx3tnbChFqGUOW6vEF7CwZ3aw3?usp=sharing)
- All workshop materials are available at [github.com/qagentur/structured-information-extraction-with-llms](https://github.com/qagentur/structured-information-extraction-with-llms)
...
## LLM architecture is inefficient
...
<div style="background-color: #e9ecef; padding: 5px; margin: 0 10px 10px 10px; border-radius: 3px;">P(Class 1)</div>
<div style="background-color: #e9ecef; padding: 5px; margin: 0 10px 10px 10px; border-radius: 3px;">P(Class 2)</div>
<div style="background-color: #e9ecef; padding: 5px; margin: 0 10px 10px 10px; border-radius: 3px;">P(Class 3)</div>
...
<div style="background-color: #e9ecef; padding: 5px; margin: 0 10px 10px 10px; border-radius: 3px;">P(Token 1)</div>
<div style="background-color: #e9ecef; padding: 5px; margin: 0 10px 10px 10px; border-radius: 3px;">P(Token 2)</div>
<div style="color: #6c757d; text-align: center; margin: 0 10px 10px 10px;">⋮</div>
<div style="background-color: #e9ecef; padding: 5px; margin: 0 10px 10px 10px; border-radius: 3px;">P(Token k)</div>
...
- Analyze text, audio and images together
...
<https://colab.research.google.com/drive/1lpQDRxTx3tnbChFqGUOW6vEF7CwZ3aw3?usp=sharing>
...
## Recap of the competition and exercises
...
## Best open weights LLMs for structured information extraction
...
Also good: Phi (Microsoft) and Qwen (Alibaba). Close models tend to be ~6 months ahead of open models. [Zhou et al. 2024](https://arxiv.org/abs/2412.02279) noted diminishing returns for larger models past 8B parameters.
...
Huge differences in cost and performance between models and providers. Use [artificialanalysis.ai](https://artificialanalysis.ai) or [llm-stats.com](https://llm-stats.com) to compare models and providers.
...
Workshop materials: [github.com/qagentur/structured-information-extraction-with-llms](https://github.com/qagentur/structured-information-extraction-with-llms)
