...
- Advanced: Implement Chain-of-Thought: an intermediate step where the model generates a free form answer, followed by a second step where the model extracts the structured output from it
...
TODO: research benchmarks closer to the workshop date

Fine-tuning beats prompting, large models beat small models
