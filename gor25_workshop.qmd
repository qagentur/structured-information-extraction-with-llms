...
- Slides will be available on my website: <https://simmering.dev/talks/gor25workshop>
...
## LLM architecture is inefficient for structured output
...
The Llama and Gemma model families from Meta and Google are solid choices. Also consider Phi from Microsoft and Qwen from Alibaba.

Open models tend to be behind leading closed models like Claude 3.7 Sonnet in terms of performance.
...
![Track every LLM call to identify issues, improve accuracy, and manage costs](assets/monitoring.svg)
