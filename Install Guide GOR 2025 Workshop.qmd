...
Set up instructor to connect to an LLM API. Replace the code related to installing and running a local LLM with the code to connect to the LLM API. The example below shows how to connect to OpenAI.
...
You can use your own API key from OpenAI or any other provider that is [compatible](https://python.useinstructor.com/integrations/) with instructor. This includes OpenAI, Anthropic, Google Cloud, and many others. See the [instructor documentation](https://python.useinstructor.com/integrations/) for more details. If you don't have an API key, please contact me ahead of time at: [paul.simmering@teamq.de](mailto:paul.simmering@teamq.de).

Using a cloud LLM requires some changes to the workshop notebook code. If you're not comfortable with this, I suggest using the Google Colab option.

--- 

If none of these options (Google Colab, local LLM, or API access via your own API key) work for you, please contact me ahead of time at: [paul.simmering@teamq.de](mailto:paul.simmering@teamq.de). I will provide you with an API key to connect with an LLM server during the workshop.
